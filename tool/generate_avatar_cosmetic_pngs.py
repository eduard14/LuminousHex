...
def joyful_arc() -> bytearray:
    b = _new_canvas()
    _draw_curve(b, [(185, 249), (218, 214), (252, 250)], 28, (105, 230, 255, 54))
    _draw_curve(b, [(185, 249), (218, 214), (252, 250)], 13, (150, 242, 255, 230))
    _draw_curve(b, [(288, 249), (321, 214), (355, 250)], 28, (105, 230, 255, 54))
    _draw_curve(b, [(288, 249), (321, 214), (355, 250)], 13, (150, 242, 255, 230))
    _draw_curve(b, [(239, 292), (267, 316), (298, 292)], 9, (196, 250, 255, 220))
    return _downsample(b)


def focused_glow() -> bytearray:
    b = _new_canvas()
    _draw_ellipse(b, (216, 238), (24, 38), (80, 220, 255, 52))
    _draw_ellipse(b, (216, 238), (13, 28), (214, 252, 255, 240))
    _draw_ellipse(b, (306, 238), (24, 38), (80, 220, 255, 52))
    _draw_ellipse(b, (306, 238), (13, 28), (214, 252, 255, 240))
    _draw_line(b, (244, 289), (285, 289), 8, (180, 246, 255, 210))
    return _downsample(b)


def spark_wink() -> bytearray:
    b = _new_canvas()
    _draw_curve(b, [(184, 248), (219, 217), (255, 248)], 25, (188, 122, 255, 54))
    _draw_curve(b, [(184, 248), (219, 217), (255, 248)], 12, (220, 190, 255, 235))
    _draw_spark(b, (309, 237), 30, (232, 215, 255, 235))
    _draw_curve(b, [(244, 294), (273, 310), (309, 287)], 8, (220, 190, 255, 220))
    return _downsample(b)
