...
void main() {
  ...
  test('starter deck defaults to White Basic and early pulls are scripted', () {
    ...
    expect(controller.coreState.coreStability, lessThan(96));
    expect(controller.outputEfficiencyMultiplier, lessThan(0.96));
    ...
    expect(controller.coreState.coreStability, greaterThanOrEqualTo(98));
    expect(controller.outputEfficiencyMultiplier, greaterThanOrEqualTo(0.96));
    ...
    expect(
      ...
      lessThan(LightcoreController.experienceForOverallLevel(2)),
    );
    ...
    controller.tick(0);
    expect(controller.tutorialStep, LightcoreTutorialStep.pushNextArea);
    expect(controller.tutorialHeadline, 'Push Next Area');
    expect(controller.canStartFirstThreatChallenge, isTrue);
    expect(controller.startFirstThreatChallenge(), isTrue);
  ...
  test('tap quest shows charge state until the tower can shoot', () {
    ...
    expect(controller.tutorialHeadline, 'Stabilize Hex 1');
    expect(
      controller.tutorialPrompt,
