...
For example, `1.0.24+25` means release version `1.0.24` and build number `25`.
...
```js
minimumSupportedVersion: "1.0.24",
minimumSupportedBuildNumber: "25",
recommendedVersion: "1.0.24",
recommendedBuildNumber: "25",
```

## Menu Display

The main menu footer renders `LightcoreBootstrapReport.clientDisplayVersion`,
so it should show the full client build, such as `V1.0.24+25`.
