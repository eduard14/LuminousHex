  ...
  Map<String, dynamic> buildCloudSavePayload() {
    ...
    return <String, dynamic>{
      ...
      'layerRebuild': <String, dynamic>{
        ...
        'layer2Board': _layer2BaseBoard.toMap(),
        'shellSequence': _layer1ShellSequence,
      },
      ...
      'tutorial': <String, dynamic>{
        ...
        'focusFireLearned': _tutorialFocusFireLearned,
        ...
        'secondShellTowerInspected': _tutorialSecondShellTowerInspected,
