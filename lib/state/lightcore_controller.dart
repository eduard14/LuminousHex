...
_tutorialQuestDefinitions = <LightcoreTutorialStep, LightcoreTutorialQuestDefinition>{
  ...
  LightcoreTutorialStep.managerAutoAim: LightcoreTutorialQuestDefinition(
    ...
    teachGoal:
        'Core Managers convert core charge into hands-off firing when the player wants automation.',
  ...
  LightcoreTutorialStep.forgeTowerManager: LightcoreTutorialQuestDefinition(
    ...
    teachGoal: 'Core Managers automate core firing across the active shell.',
    trigger: 'Manager foundry opened with enough Flux',
    primaryClickTarget: 'Managers > Core Manager foundry > Forge',
    coachCopy:
        'Forge one Core Manager. A manager keeps core fire moving through automation.',
