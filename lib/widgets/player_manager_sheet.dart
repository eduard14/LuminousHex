...
class _AvatarCustomizationBoard extends StatelessWidget {
  const _AvatarCustomizationBoard({required this.controller});
...
class _AvatarPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text('Profile Icon', style: Theme.of(context).textTheme.titleMedium),
