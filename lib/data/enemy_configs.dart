...
class EnemyLibrary {
  ...
  static final List<_EnemyColorSeed> _colors = <_EnemyColorSeed>[
    ...
    const _EnemyColorSeed(
      ...
      rewardMultiplier: 2.85,
      threatRewardMultiplier: 2.85,
    ...
    const _EnemyColorSeed(
      ...
      speedMultiplier: 0.98,
      rewardMultiplier: 2.55,
      threatRewardMultiplier: 2.55,
      stabilityDamageMultiplier: 1.18,
      jamMultiplier: 1.0,
    ...
    const _EnemyColorSeed(
      ...
      rewardMultiplier: 3.75,
      threatRewardMultiplier: 3.75,
  ...
  static EnemyConfig _buildConfig(
    ...
    return EnemyConfig(
      ...
      baseExperience: (rarity.baseExperience * color.rewardMultiplier).round(),
